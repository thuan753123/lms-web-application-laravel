                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                ...
                                {{--   <tr>
                                       <td valign="top" class="footerContent" mc:edit="footer_content00">
                                           <a href="*|TWITTER:PROFILEURL|*">Theo dõi trên Twitter</a>&nbsp;&nbsp;&nbsp;<a href="*|FACEBOOK:PROFILEURL|*">Kết bạn trên Facebook</a>&nbsp;&nbsp;&nbsp;<a href="*|FORWARD|*">Chuyển tiếp cho bạn bè</a>&nbsp;
                                       </td>
                                   </tr>--}}
                            </table>
                            <!-- // END FOOTER -->
