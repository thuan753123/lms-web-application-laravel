                                            ...
                                            <form id="payment-card-info" method="post" action="/payments/payment-request">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-8" id="card-number-field">
                                                        ...
                                                        <span id="card-error" class="error text-red">Vui lòng nhập số thẻ hợp lệ</span>
                                                    </div>
                                                    <!--<div class="form-group col-md-4" >-->
                                                    <!--    <label for="amount">Số tiền</label>-->
                                                <!--    <input type="number" class="form-control" id="amount" name="amount" min="1" value="{{ old('amount') }}" required>-->
                                                    <!--    <span id="amount-error" class="error text-red">Vui lòng nhập số tiền</span>-->
                                                    <!--</div>-->
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="form-group" id="pay-now">
                                                    <button type="submit" class="btn btn-success themeButton" id="confirm-purchase">Xác nhận thanh toán</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
