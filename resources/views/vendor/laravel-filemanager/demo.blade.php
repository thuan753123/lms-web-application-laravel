...
<head>
  ...
  <title>Quản lý tập tin Laravel</title>
...
<body>
  <div class="container">
    <h1 class="page-header">Trang demo tích hợp</h1>
    <div class="row">
      <div class="col-md-6">
    ...
    <div class="row">
      <div class="col-md-6">
        <h2 class="mt-4">Trình soạn thảo</h2>
        <textarea id="summernote-editor" name="content"></textarea>
      </div>
      <div class="col-md-6">
        <h2 class="mt-4">Nút hình ảnh độc lập</h2>
        ...
        <h2 class="mt-4">Nút tập tin độc lập</h2>
        <div class="input-group">
          <span class="input-group-btn">
    ...
    <div class="row">
      <div class="col-md-12">
        <h2 class="mt-4">Nhúng quản lý tập tin</h2>
