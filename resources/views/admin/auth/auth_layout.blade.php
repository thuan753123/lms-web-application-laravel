    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">LMS AI168</h1>
                <h5 class="font-weight-normal text-muted-transparent">fully-featured educational platform</h5>
              </div>
              Tất cả quyền được bảo lưu cho <a class="text-light bb" target="_blank" href="https://ai168.vn">AI168</a> - Nền tảng học tập thông minh
            </div>
          </div>
            </div>
