                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" id="fsdate" class="text-center form-control" name="from" value="{{ request()->get('from') }}" placeholder="Ngày bắt đầu">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" id="lsdate" class="text-center form-control" name="to" value="{{ request()->get('to') }}" placeholder="Ngày kết thúc">
                                    </div>
                                </div>
                            </div>
                            ...
                            <tr>
                                ...
                                <td class="" width="50">
                                    ...
                                    @can('admin_reviews_detail_show')
                                        ...
                                        <button type="button" class="js-show-review-details btn-transparent text-primary mr-1" data-toggle="tooltip" data-placement="top" title="Chi tiết đánh giá">
