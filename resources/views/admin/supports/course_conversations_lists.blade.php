                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" id="from" class="text-center form-control" name="from" value="{{ request()->get('from') }}" placeholder="Ngày bắt đầu">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" id="to" class="text-center form-control" name="to" value="{{ request()->get('to') }}" placeholder="Ngày kết thúc">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="status" data-plugin-selectTwo class="form-control populate">
                                        ...
                                        <option value="open" @if(request()->get('status') == 'open') selected @endif>Mở</option>
                                        <option value="close" @if(request()->get('status') == 'close') selected @endif>Đóng</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="webinar_ids[]" multiple="multiple" class="form-control search-webinar-select2"
                                            data-placeholder="Tìm kiếm lớp học">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="teacher_ids[]" multiple="multiple" data-search-option="just_teacher_role" class="form-control search-user-select2"
                                            data-placeholder="Tìm kiếm giảng viên">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="student_ids[]" multiple="multiple" data-search-option="just_student_role" class="form-control search-user-select2"
                                            data-placeholder="Tìm kiếm học viên">
