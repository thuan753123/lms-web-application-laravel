                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" id="fsdate" class="text-center form-control" name="date" value="{{ request()->get('date') }}" placeholder="Ngày">
                                    </div>
                                </div>
                            </div>
                            ...
                            @elseif($page == 'bundles')
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="bundle_ids[]" multiple="multiple" class="form-control search-bundle-select2 " data-placeholder="Tìm kiếm gói">
                            ...
                            @elseif($page == 'blog')
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="post_ids[]" multiple="multiple" class="form-control search-blog-select2 " data-placeholder="Tìm kiếm blog">
                            ...
                            @elseif($page == 'products')
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="product_ids[]" multiple="multiple" class="form-control search-product-select2 " data-placeholder="Tìm kiếm sản phẩm">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="user_ids[]" multiple="multiple" class="form-control search-user-select2"
                                            data-placeholder="Tìm kiếm người dùng">
